...
// tokio::test is the tesing equivalent of `tokio::main`.
...
async fn subscribe_returns_a_200_for_valid_form_data() {
    ...
    let body = "name=le%20guin&email=urshula_le_guin%40gmail.com";
    let response = client
    ...
    assert_eq!(saved.email, "urshula_le_guin@gmail.com");
